...
write_root2 = '/home/pavel/ITMO/NIR2/data/SensetUrban_converted/images'
...
def pooling2d(inputMap, poolSize, poolStride, pool_func):
    ...
    # padding
    temp_map = np.pad(inputMap, ((0, poolSize-row_remainder), (0, poolSize-col_remainder)), mode='edge')
